...
:map <F2> :set filetype=c<cr>i/*<cr>CPE 101 Spring 2014<cr>-------------------<cr>Assignment: <cr><cr>Author:Nicholas Berrichoa <cr>Last Modified: <cr>/<cr><cr>#include <unistd.h><cr>#include <sys/types.h><cr><cr>#include <stdlib.h><cr>#include <stdio.h><cr>#include <math.h><cr>#include <string.h><cr>#include <ctype.h><cr><cr>int main(int argc, char *argv[]) {<cr><cr>return EXIT_SUCCESS;<cr>}<cr><esc>
